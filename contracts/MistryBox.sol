...
contract ERC1155Base is HasSecondarySaleFees, Ownable, ERC1155Metadata_URI, HasContractURI, ERC1155 {
    ...
    // Creates a new token type and assings _initialSupply to minter Fee[] memory _fees,
...
contract LiquidiftyCollection is Ownable, ERC1155Base {
    ...
    function mint(uint256 _id, uint256 supply, string memory uri) public {
        _mint(_id,  supply, uri);
    }
}